...
/**
 * {@link ScreenControl} implementation based on adb.
 *
 * @author wautsns
 * @since {{{SINCE_PLACEHOLDER}}}
 */
@Accessors(fluent = true)
public final class ADBScreenControl implements ScreenControl {
    ...
    public ADBScreenControl(Config config) {
